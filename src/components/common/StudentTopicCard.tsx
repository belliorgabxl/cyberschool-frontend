  ...
  return (
    ...
    >
      <div className="w-full flex justify-start gap-3 items-center mb-4">
        <div
          className={`px-2 py-2 ${bg_icon}  tex-white rounded-full shadow-md shadow-gray-400 `}
        >
          {icons}
        </div>
      ...
      <div className="flex justify-between items-center">
        ...
        <span
          className={`flex gap-2 justify-center items-center text-white bg-gradient-to-r ${from_color} ${to_color} hover:from-blue-900 hover:to-sky-500  px-5 py-2 rounded-md`}
        >
